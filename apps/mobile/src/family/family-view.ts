import type { ChildDevice, FamilyChild, FamilyOverview } from '@pencillift/contracts';
...
/** Honest paid-slot explanation: activation happens in subscription management, not here. */
export function slotSummary(family: FamilyOverview): string {
  ...
  return `${slots}, ${active} in use. New children start as free drafts; activating one assigns a paid slot from your subscription.`;
}
