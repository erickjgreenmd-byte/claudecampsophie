...
export const routes: RouteObject[] = [
  ...
  { path: '/sign-in', lazy: page(() => import('./pages/auth/SignInPage.tsx')) },
  { path: '/sign-up', lazy: page(() => import('./pages/auth/SignUpPage.tsx')) },
  { path: '/reset-password', lazy: page(() => import('./pages/auth/ResetPasswordPage.tsx')) },
  { path: '/update-password', lazy: page(() => import('./pages/auth/UpdatePasswordPage.tsx')) },
  { path: '/app', lazy: page(() => import('./pages/app/FamilyDashboardPage.tsx')) },
  { path: '/app/security/reset-pin', lazy: page(() => import('./pages/app/PinResetPage.tsx')) },
